(function(exports) {
	...
	var refreshText = function() {
		...
		var words = splitText(g_name);
                ...
                if(words === 'pop' || words === 'funk'){
                    words === 'blues';
                } else if (words === 'hip hop' || words === 'rap'){
                    words === 'country';
                } else if (words === 'acoustic' || words === 'classic'){
                    words === 'punk';
                } else if (words === 'folk' || words === 'country'){
                    words === 'hip hop';
                } else if (words === 'rock' || words === 'punk'){
                    words === 'acoustic';
                } else if (words === 'jazz' || words === 'blues'){
                    words === 'pop';
                } else {
                    words;
                }
	...
	var refreshtimer = 0;
	var queueRefreshText1 = function() {
		if (refreshtimer) {
